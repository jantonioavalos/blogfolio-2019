...
const Temp = ({ data, pageContext }) => {
  ...
  const disqusConfig = {
    shortname: "jantonioavalos", //your site shortname here
    ...
    <div className={"row post " + theme}>
      ...
      <div className={"col-lg-4 px-5 post-prefix bg-" + theme}>
        <div className="flexbox">
          <AniLink to="/" cover direction="right" bg="#00BCD4">
            <img
              src="https://img.icons8.com/material-rounded/48/00bcd4/back.png"
              width="48"
              alt="back-icon"
            />
          </AniLink>
          ...
          <div className="row">
            ...
            <span className="col my-auto">
              <AniLink fade className="font-weight-bold" to="/about">
                {frontmatter.author}
              </AniLink>
